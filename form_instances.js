...
function investigate(obj, space = 0, path = obj, parent = null, grandparent = null) {
    ...
    if (main)
        ...
        console.log(`%cInvestigating ${path}`, "color: #773");
    if (obj)
            ...
            try {
                ...
                if (!recursive && space < 5 && (type == 'object'))
                    ...
                    if (main)
                        ...
                        console.log(`%c${'  '.repeat(space)} ${k}(${type}): ${obj[k]}`, "color: #773");
                }
            }
            catch (_a) {
...
localChapters.mainHTML = function () {
...
//git commit -m "Restructured code to use form Objects as the main structure. Repurposed website object to just have basic login and page load functions" -a
//--------------------------------------------------------------
//------------------       TEST FUNCTIONS FORM        ----------
//--------------------------------------------------------------
...
settings.mainHTML = function (id) {
    ...
    if (this.parameters.fictions === undefined)
        this.parameters.fictions = {};
...
settings.compose = function () {
    ...
    if (fictions)
        fictionsNr = Object.keys(fictions).length;
...
settings.saveSettings = function (args) {
...
//--------------------------------------------------------------
module.exports = form;
//# sourceMappingURL=form_instances.js.map